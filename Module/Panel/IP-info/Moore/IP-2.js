...
// 去除ISP信息中的无意义信息
let cleanedIsp = isp.replace(/\s?[,]|\s\-|\.$|\(.*\)|(\b(Hong Kong|Mass internet|Communications?|information|Technolog(y|ies)|Taiwan|ESolutions?|(?<=.*Hytron)Services?)\b)\s?|munications?/gi, '');    
// 避免可能出现的连续空格
