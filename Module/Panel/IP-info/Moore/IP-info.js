...
let cleanedIsp = isp.replace(/[,]|(\.$)|\([^)]*\)|\-|DinServer|Communications|Trading|Mass|Telekomunikasyon|Hosted|Information|Technology|Technologies|Television|Registration|Internet/gi, '');
