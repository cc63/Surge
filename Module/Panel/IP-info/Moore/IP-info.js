...
let cleanedIsp = isp.replace(/[,]|(\.$)|\([^)]*\)|\-|DinServer|Communications|Trading|as|Telekomunikasyon|Hosted|Information|Technology|Technologies|Television|Registration|MsInternet|Internet/gi, '');
