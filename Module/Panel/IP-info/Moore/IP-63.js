...
// 去除ISP信息中的无意义信息
let cleanedIsp = isp.replace(/\s?[,]|\s\-|\.$|\(.*\)|(\b(AS\d+|Hong Kong|Mass internet|Communications?|information|Technolog(y|ies)|Taiwan|Services?|ESolutions?)\b)\s?|munications?/gi, '');    
// 避免可能出现的连续空格
